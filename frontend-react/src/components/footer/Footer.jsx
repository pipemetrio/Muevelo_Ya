    ...
    <footer className="footer">
      ...
      <div className="footer-top">
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            <li><span>📧</span> contacto@mueveloya.com</li>
            <li><span>📞</span> +57 300 000 0000</li>
            <li><span>📍</span> Medellín, Colombia</li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <p>© 2026 <span className="footer-brand">Muévelo Ya</span>. Todos los derechos reservados.</p>
      </div>
